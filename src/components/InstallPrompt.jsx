                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-sm text-muted-foreground leading-relaxed">
                                    Tap the <span className="font-bold text-foreground inline-flex items-center gap-1">Share <Share className="h-4 w-4" /></span> icon (in the navigation bar or browser menu), then scroll down and tap <span className="font-bold text-foreground inline-flex items-center gap-1">Add to Home Screen <span className="text-xl leading-none">+</span></span>.
                                </p>
                            </div>
                        </div>
                    </div>
